...
export default function Console() {
  ...
  async function ask() {
    ...
    setCitations([])
    try {
      const res = await runQuery({ apiKey, userEmail, userDomain, userClearance }, query)
            ...
            <Card className="bg-gray-900/60 border border-emerald-800 shadow-lg rounded-2xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    <Button onClick={ask} className="px-8 bg-gradient-to-r from-emerald-500 to-teal-400 text-black font-semibold hover:opacity-90 shadow-lg shadow-emerald-500/30">
                      Ask
                    </Button>
                  </motion.div>
                </div>
